...
function MessageCard({ cert, myPublicKey, onLongPress }: { cert: RetMsgCert, myPublicKey: string, onLongPress: (c: RetMsgCert) => void }) {
      ...
      <View style={[styles.header, { paddingTop: Math.max(insets.top, 10) }]}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.logoWrap}>
            <SvgXml xml={LIBR_LOGO_SVG} width="24" height="24" />
          </View>
          <Text style={styles.channelName}>libr</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  channelName: { fontSize: 22, fontWeight: '800', color: C.text },
  ...
  debugTitle: { color: '#a0a0c0', fontSize: 11, fontWeight: '700', marginBottom: 4 },
  debugLine: {
    color: '#c0ffc0',
    fontSize: 10,
  ...
  centeredText: { color: C.muted, fontSize: 14 },
  emptyText: {
    textAlign: 'center',
    marginTop: 60,
    color: C.muted,
  ...
  aliasText: { fontSize: 13, fontWeight: '700', flexShrink: 1 },
  titleText: { fontSize: 16, fontWeight: '700', color: C.text, marginBottom: 2 },
  mineTag: {
    fontSize: 10,
    color: C.teal,
  ...
  contentText: { color: C.text, fontSize: 15, lineHeight: 22 },
  timeText: { color: C.muted, fontSize: 11, alignSelf: 'flex-end', marginTop: 4 },
